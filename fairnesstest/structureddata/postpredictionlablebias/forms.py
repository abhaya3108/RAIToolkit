...
class LableBiasPostPredictionForm(forms.Form):
    ...
    prediction_file = forms.FileField(label='Upload Predictions File:', error_messages={'required':'Please Upload Predicted Probabilities'}, widget=forms.FileInput(attrs={'class':'form-control', 'accept':".csv"}))
