...
def cam_result(model_file_path=None, image_file_name=None, folder_path=None, unique_id=None):
    ...
    # to our screen
    if not os.path.exists(f'{folder_path}\\cam_images'):
        os.mkdir(f'{folder_path}\\cam_images')
    original = f'{folder_path}\\cam_images\\{unique_id}_original.png'
    heat_map = f'{folder_path}\\cam_images\\{unique_id}_heat_map.png'
    cam_result = f'{folder_path}\\cam_images\\{unique_id}_cam_result.png'
